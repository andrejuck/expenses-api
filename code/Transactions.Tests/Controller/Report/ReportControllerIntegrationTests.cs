...
namespace Transactions.Tests.Controller.Report;
internal class ReportControllerIntegrationTests : BaseIntegrationTest
{
    ...
    private ResourceManager _resourceManager = new ResourceManager("Transactions.Api.Resources.SharedResources", typeof(Program).Assembly);
