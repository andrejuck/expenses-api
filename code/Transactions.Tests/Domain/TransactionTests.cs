...
public class TransactionTests
{
    ...
    private static PaymentMethod Cash() => new("Dinheiro", PaymentType.Cash, null, false);
    ...
    {
        Assert.Throws<DomainException>(() =>
            new Transaction(null, "Mercado", 100, DateTime.Today, null, Cash(), TransactionType.Expense, 2));
    }
    ...
    public void Given_a_credit_card_payment_When_dividing_by_installments_Then_it_generates_the_expected_number_of_transactions_with_indexed_description()
    {
        ...
        var transaction = new Transaction(null, "Mercado", 100, DateTime.Today, null, paymentMethod, TransactionType.Expense, 2);
    ...
    {
        var paymentMethod = CreditCard();
        var transaction = new Transaction(null, "Mercado", 100, DateTime.Today, null, paymentMethod, TransactionType.Expense, 3);
    ...
    {
        var creditCardTransaction = new Transaction(null, "Mercado", 100, DateTime.Today, null, CreditCard(), TransactionType.Expense, 2);
